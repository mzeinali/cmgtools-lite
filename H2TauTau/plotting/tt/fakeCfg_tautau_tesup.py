...
#inc_cut = inc_sig_no_iso & ~charge_cut & lowmet_cut # check contamination of non-qcd in qcd control region
...
inc_cut = inc_sig_no_iso & charge_cut & baseline_cut_modified & mt2upper_cut & summt_cut & gt0_jet & nbVeto_cut # SR IV
...
cuts.append(myCut('tes_down_sr4_0b', inc_cut ))
...
for cut in cuts:
    ...
    cut = myCut(cut.name, cut.cut & iso_cut) 
