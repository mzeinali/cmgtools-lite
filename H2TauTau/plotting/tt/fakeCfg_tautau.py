...
baseline_cut_modified_noMT2cut = Cut('pfmet_pt > 30 && mvis > 100')
...
inc_cut = inc_sig_no_iso & charge_cut & baseline_cut_modified & mt2lower_cut ## SR 1, previous def
#inc_cut = inc_sig_no_iso & charge_cut & baseline_cut_modified & mt2upper_cut & nbVeto_cut & summt_cut ## SR 2, previous def
...
#inc_cut = inc_sig_no_iso & charge_cut & baseline_cut_modified_noMT2cut & mt2upper_cut & summt_cut & gt0_jet # SR IV
...
#cuts.append(myCut('checkmt2_sr4', inc_cut ))

#variables = getVars(['mt2'])

inc_cut = inc_sig_no_iso & charge_cut & ~met_cut ## ditau_pt_cut
cuts.append(myCut('pablo_comment', inc_cut ))
#
