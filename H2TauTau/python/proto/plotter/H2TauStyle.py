...
# sHTT_Higgs = Style(lineColor=kBlue, markerColor=0, lineStyle=2, fillColor=0, lineWidth=3) # the default one was this! changed on 17 sep!
sigcol = TColor.GetColor(255,0,0)
sHTT_Higgs = Style(lineColor=sigcol, markerColor=0, lineStyle=1, fillColor=0, lineWidth=3)
sigcol_low = TColor.GetColor(255,0,255)
sms_low = Style(lineColor=sigcol_low, markerColor=0, lineStyle=2, fillColor=0, lineWidth=4)
sigcol_mod = TColor.GetColor(127,0,255)
sms_mod = Style(lineColor=sigcol_mod, markerColor=0, lineStyle=9, fillColor=0, lineWidth=3)
zlcol = TColor.GetColor(100,182,232)
sHTT_ZL = Style(lineColor=1, markerColor=zlcol, fillColor=zlcol)
dibosoncol = TColor.GetColor(0,255,0)
...
histPref['DYJets'] = {'style':sHTT_DYJets, 'layer':1.5, 'legend':'Z+jets'} ## added on 17 Sep
#histPref['DYJets'] = {'style':sHTT_DYJets, 'layer':4, 'legend':'Z+jets'} ## added on 17 Sep
...
histPref['TT'] = {'style':sHTT_TTJets, 'layer':1, 'legend':'Top'} 
...
histPref['FakeEstimation'] = {'style':sHTT_QCD, 'layer':2, 'legend':'jet->#tau_{h} mis-ID'}
...
histPref['SMS_DM_400'] = {'style':sHTT_Higgs, 'layer':1001, 'legend':None}
histPref['SMS_400_1'] = {'style':sHTT_Higgs, 'layer':1001, 'legend':None}
histPref['SMSDM400*'] = {'style':sHTT_Higgs, 'layer':1001, 'legend':None}
histPref['SMS_DM_200'] = {'style':sms_mod, 'layer':1001, 'legend':None}
histPref['SMS_250_50'] = {'style':sms_mod, 'layer':1001, 'legend':None}
histPref['SMSDM200*'] = {'style':sms_mod, 'layer':1001, 'legend':None}
histPref['SMS_DM_100'] = {'style':sms_low, 'layer':1001, 'legend':None}
histPref['SMS_200_100'] = {'style':sms_low, 'layer':1001, 'legend':None}
histPref['SMSDM100*'] = {'style':sms_low, 'layer':1001, 'legend':None}
